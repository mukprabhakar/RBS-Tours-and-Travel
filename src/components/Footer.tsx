          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-primary-foreground/70">krishnakant bhardwaj</p>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/80">
                  sector 1 jalpura g noida
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-accent flex-shrink-0" />
                <span className="text-primary-foreground/80">93107 00129</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary-foreground/60 text-sm text-center md:text-left">
              © {currentYear} RBS TOURS AND TRAVELS. All rights reserved.
            </p>
